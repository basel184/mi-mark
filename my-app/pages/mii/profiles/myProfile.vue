...
<template>
  ...
  <div>
    <template  v-if="user.info && user.info.length > 0">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10"></path>
                     ...
                     <img class="object-cover object-center w-14 w-14" :src="user.rule.image" alt='New image'>
                      ...
                      <div class="border rounded-md w-3/6 flex justify-center">
                        <button  class="text-white py-2 px-4 uppercase rounded bg-blue-400 hover:bg-blue-500 shadow hover:shadow-lg font-medium transition transform hover:-translate-y-0.5">  Gallery</button>
...
<div class="flex">
  ...
  <section id="login" class="p-4 flex flex-col justify-center min-h-screen max-w-md mx-auto">
    <div class="p-6 bg-sky-100 rounded">
      <div class="flex items-center justify-center font-black m-3 mb-12">
              <h3 class="tracking-wide text-md text-gray-900">Please Complete your Personal Information To see your Profile</h3>
  ...
  <label for="date_of_birth">Date of birth</label>
    ...
    <input id="male" type="radio" v-model="gender" name="gender" value="Male" class="w-4 h-4 border-gray-300 focus:ring-2 focus:ring-blue-300 dark:focus:ring-blue-600 dark:focus:bg-blue-600 dark:bg-gray-700 dark:border-gray-600" checked>
  ...
  <div class="flex items-center mb-4">
    <input id="female" type="radio" v-model="gender"  name="gender" value="Female" class="w-4 h-4 border-gray-300 focus:ring-2 focus:ring-blue-300 dark:focus:ring-blue-600 dark:focus:bg-blue-600 dark:bg-gray-700 dark:border-gray-600">
